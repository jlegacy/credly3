...
List<badge_rules__c> rules = [SELECT Id, account_type_r__c, badge_lookup__c, badge_rule_r__c,
         ...
         rule_name_r__c, testimonial_r__c, number_of_badges_issued_r__c,date_last_issued_r__c, send_email_r__c, evidence_url_r__c FROM badge_rules__c WHERE account_type_r__c = 'Lead'];
Id[] badgeIDs = new Id[]{};
